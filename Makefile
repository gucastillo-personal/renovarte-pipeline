...
.PHONY: help install test lint typecheck check ingest transform publish publish-live \
        pdf-extract _require-pdf-args _require-catalogo-checkout
...
help:
	...
	@echo "  make pdf-extract [PDF=...] [FUENTE=...]  PDF de LACA -> data/reference/laca_pdf_precios.csv"
	@echo "  make ingest                              etapa 1: descarga cruda de Serlaca"
	@echo "  make transform                           etapa 2: crudo + PDF + ofertas -> products.json"
	@echo ""
